...
MINHA_PORTA_TCP = 8004 # Porta TCP específica para receber comandos
...
class CameraEstacionamento:
    def __init__(self):
        self.ligada = True
        self.resolucao = "HD" # Exemplo: HD (720p), FullHD (1080p), 4K
    ...
    def anunciar_presenca(self):
        ...
        # Definida como ATUADOR, mas pode ser MISTO se enviar dados de vídeo/estado
        msg.registro.tipo_dispositivo = "ATUADOR" 
        
        print(f"📷 [CAM-EST] Anunciando presença via Multicast...")
