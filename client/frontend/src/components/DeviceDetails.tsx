...
export function DeviceDetails() {
  ...
  const isSensor =
    ...
    device.type === "air_quality_sensor";
  ...
  const checkAlert = () => {
    ...
    if (device.type === "air_quality_sensor") {
      ...
      if (device.sensorData.value > threshold)
        return `AQI acima de ${threshold}`;
    }
          ...
          <>
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setLocalConfig({ ...localConfig, resolution: e.target.value })
                }
          ...
          <>
              ...
              <div className="flex gap-3">
                {(["red", "yellow", "green"] as const).map((color) => (
                  <button
                    key={color}
                    onClick={() =>
                      setLocalConfig({ ...localConfig, currentState: color })
                    }
            ...
            <div className="flex items-start gap-2 p-3 bg-slate-800/50 rounded-lg">
              ...
              <p className="text-xs text-slate-500">
                O semáforo muda automaticamente a cada 10 segundos. Use os
                botões acima para forçar uma mudança manual.
              </p>
            </div>
          </>
        );
      ...
      case "street_lamp":
        return (
          <>
            <div>
              <label className="block text-sm text-slate-400 mb-2">
                Luminosidade ({localConfig.brightness || 100}%)
              </label>
              <input
                type="range"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalConfig({
                      ...localConfig,
                      alertMinTemp: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-3 bg-primary-50 border border-slate-700 rounded-xl text-slate-100 outline-none focus:border-accent-cyan transition-all"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalConfig({
                      ...localConfig,
                      alertMaxTemp: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-3 bg-primary-50 border border-slate-700 rounded-xl text-slate-100 outline-none focus:border-accent-cyan transition-all"
                />
        ...
        <>
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              {device.sensorData && (
                <div
                  className={`bg-primary-100 rounded-xl p-4 ${
                    alertMessage ? "ring-2 ring-accent-red/50" : ""
                  }`}
                >
                  <h3 className="text-sm font-medium text-slate-400 mb-3">
                    Dados do Sensor
                  ...
                  <div className="text-center py-4">
                    <span
                      className={`text-4xl font-bold font-mono ${
                        alertMessage ? "text-accent-red" : "text-accent-cyan"
                      }`}
                    >
